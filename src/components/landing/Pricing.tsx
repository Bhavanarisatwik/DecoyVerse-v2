                ...
                <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    {plans.map((plan, index) => (
                        <motion.div
                            ...
                            className={`relative rounded-3xl border p-6 flex flex-col transition-all duration-500 hover:-translate-y-1 ${plan.popular
                        ...
                        >
                            ...
                            <Link to="/auth/signup" className="mb-6">
                                <Button
                                    className={`w-full rounded-full transition-all duration-300 hover:scale-[1.02] ${plan.popular
