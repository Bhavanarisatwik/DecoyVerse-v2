...
import { Ghost, Lock, Mail, AlertCircle, Shield, Activity, Server, ChevronRight } from "lucide-react"
        ...
        <div className="min-h-screen flex bg-themed-primary">
            ...
            <div className="auth-panel-left hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12">
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                    <div className="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-accent/15 blur-[120px]" />
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <div className="space-y-4">
                        {[
                            { icon: Shield, label: "Proactive threat detection", desc: "Catch attackers before they reach critical systems" },
                            { icon: Activity, label: "Real-time alerts", desc: "Instant notifications via Slack, email, or webhook" },
                            { icon: Server, label: "Multi-node deployment", desc: "Deploy decoys across all your infrastructure nodes" },
            ...
            <div className="flex flex-1 items-center justify-center px-6 py-12 relative">
                ...
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none lg:hidden">
                    <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-accent/10 blur-[100px]" />
                            ...
                            <CardFooter className="flex flex-col gap-4">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-0 flex items-center">
                                        <span className="w-full border-t border-themed" />
                                    </div>
                                    <div className="relative flex justify-center text-xs uppercase">
                                        <span className="bg-themed-card px-2 text-themed-muted">Or continue with</span>
                                    </div>
                                </div>
